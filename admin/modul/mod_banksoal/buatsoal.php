					...
					<div class="panel panel-success">
						...
						<div class="panel-body text-center">
							<div class="form-group">
								<label>Judul</label>
								<p>
									<?php echo $esoal['nama_soal']; ?>
								</p>
							</div>
							<div class="form-group">
								<label>Mata Pelajaran</label>
								<p>
									<?php echo $esoal['nama_mapel']; ?>
								</p>
							</div>
							<div class="form-group">
					...
					if (isset($_GET['v'])) {
						switch ($_GET['v']) {
							case 'add':
								...
								<form method="post" action="modul/mod_banksoal/aksi.php?act=tbsoal" enctype="multipart/form-data">
									<div class="col-md-6">
										...
										$ks = "your_prefix"; // Tambahkan baris ini dan gantilah "your_prefix" dengan nilai yang sesuai
										...
										$kodeurut = (int)substr($max['kode'], strlen($ks), 3) + 1;
										...
										<div class="form-group">
											<label>No</label>
											<input type="text" class="form-control" name="no" disabled="disabled"
												value="<?php echo $kd_detail_soal; ?>">
								...
								<form onSubmit="return validateForm()" enctype="multipart/form-data" method="POST"
									action="modul/mod_banksoal/aksi.php?act=import">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<div class="alert alert-info">
											...
											<p>Hanya file excel dengan extensi .xls yang dapat digunakan. Format excel dapat didownload
												<b><a href="files/format_soal/format_import_soal.xls">disini</a></b>.</p>
							...
							case 'tampil':
								?>
								<div class="row">
									<a href="<?php echo "?module=buatsoal&v=add&kds=$_GET[kds]"; ?>" class="btn btn-primary">Tambah
										Pertanyaan</a>
									<hr>
								</div>
								<div class="row">
													...
													<tbody>
														...
														while ($rpert = mysqli_fetch_array($qpert)) {
															...
															<tr>
																...
																<td class="text-left">
																	<?php echo $tkun . ". " . $rpert[$key]; ?>
																</td>
																<td>
																	<a href="media.php?module=<?php echo "buatsoal&v=edit&kds=$rpert[kd_soal]&kdd=$rpert[kd_detail_soal]"; ?>"
																		class="btn btn-warning">EDIT</a>
																	<a href="modul/mod_banksoal/aksi.php?act=delpert&kdd=<?php echo $rpert['kd_detail_soal']; ?>"
							...
							case 'edit':
								...
								<div class="panel panel-success">
									...
									<div class="panel-body text-center">
										<form method="post" action="modul/mod_banksoal/aksi.php?act=tbedit"
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label>No</label>
													<input type="text" class="form-control" name="no" disabled="disabled"
														value="<?php echo $max['kd_detail_soal']; ?>">
													<input type="hidden" name="kd_soal" value="<?php echo $max['kd_soal']; ?>">
													<input type="hidden" name="kd_detail" value="<?php echo $kdd; ?>">
												</div>
												<div class="form-group">
													<label>Jenis Ketergantungan</label>
													<select class="form-control" name="jenis" id="cbbketergantungan"
														data-soal="<?php echo $max['kd_soal']; ?>"
														data-detail="<?php echo $max['kd_detail_soal']; ?>">
														<option value="-" <?php if ($max['C'] == '-' and $max['P'] == '-') {
															echo "Selected='selected'";
														} else {
														} ?>>Normal</option>
														<option value="Parent" <?php if ($max['C'] == 'Y' and $max['P'] == '-') {
															echo "Selected='selected'";
														} else {
														} ?>>Parent</option>
														<option value="Child" <?php if ($max['C'] == '-' and $max['P'] != '-') {
															echo "Selected='selected'";
														} else {
														} ?>>Child</option>
													</select>
												...
												<div class="form-group">
													<label>PERTANYAAN</label>
													<textarea class="form-control" name="pertanyaan"
														rows="8"><?php echo $max['soal']; ?></textarea>
												</div>
												<div class="form-group">
												...
												<div class="form-check form-check-inline">
													<input class="form-check-input" type="checkbox" id="inlineCheckbox" name="hapus"
														value="hapusgbr">
											...
											<div class="form-group col-md-6">
												<div class="form-group">
													<label>A</label>
													<input type="text" class="form-control" name="a" placeholder="Pilihan A"
														value="<?php echo $max['pil_A']; ?>">
												</div>
												<div class="form-group">
													<label>B</label>
													<input type="text" class="form-control" name="b" placeholder="Pilihan B"
														value="<?php echo $max['pil_B']; ?>">
												</div>
												<div class="form-group">
													<label>C</label>
													<input type="text" class="form-control" name="c" placeholder="Pilihan C"
														value="<?php echo $max['pil_C']; ?>">
												</div>
												<div class="form-group">
													<label>D</label>
													<input type="text" class="form-control" name="d" placeholder="Pilihan D"
														value="<?php echo $max['pil_D']; ?>">
												</div>
												<div class="form-group">
													<label>E</label>
													<input type="text" class="form-control" name="e" placeholder="Pilihan E"
														value="<?php echo $max['pil_E']; ?>">
												</div>
												<div class="form-group">
													<label>KUNCI JAWABAN</label>
													<select class="form-control" name="kunci_jawaban">

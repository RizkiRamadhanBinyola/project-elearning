...
if (isset($_GET['act'])){
    switch ($_GET['act']) {
        case 'add':
            if (isset($_POST['nama_ujian'], $_POST['deskripsi'], $_POST['tgl_mulai'], $_POST['jam_mulai'], $_POST['tgl_ahir'], $_POST['jam_ahir'], $_POST['jam'], $_POST['menit'], $_POST['detik'], $_POST['kd_soal'], $_POST['kd_kls'], $_POST['mapel'], $_POST['kd_guru'])) {
                ...
                foreach ($kd_kelas as $kd) {
                    ...
                    $kodeurut=(int)substr($max['kode'],strlen($k),3)+1; // Mengonversi ke integer
                    if ($kodeurut<10) {
                ...
                echo "<script>alert('Data yang diperlukan tidak lengkap'); location='../../media.php?module=ujian'</script>";
            }

            break;

        case 'edit':
            if (isset($_POST['kd_ujian'], $_POST['nama_ujian'], $_POST['deskripsi'], $_POST['tgl_mulai'], $_POST['jam_mulai'], $_POST['tgl_ahir'], $_POST['jam_ahir'], $_POST['jam'], $_POST['menit'], $_POST['detik'], $_POST['kd_soal'], $_POST['kd_kelas'], $_POST['mapel'], $_POST['kd_guru'])) {

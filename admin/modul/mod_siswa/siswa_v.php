                      ...
                      <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group mb-3">
                              ...
                              <select class="form-control" name="kelamin">
                                  ...
                                  <option value="L" <?= (!$update) ?: (($row["kelamin"] != "L") ?: 'selected="on"') ?>>--Laki - Laki--</option>
                                  <option value="P" <?= (!$update) ?: (($row["kelamin"] != "P") ?: 'selected="on"') ?>>--Perempuan--</option>
                              </select>
                          </div>
                          <!-- Input untuk E-Mail -->
                          <div class="form-group mb-3">
                          ...
                          <div class="form-group mb-3">
                              ...
                              <select class="form-control" name="status">
                                  ...
                                  <option value="Aktif" <?= (!$update) ?: (($row["status"] != "Aktif") ?: 'selected="on"') ?>>--Aktif--</option>
                                  <option value="NonAktif" <?= (!$update) ?: (($row["status"] != "NonAktif") ?: 'selected="on"') ?>>--Non Aktif--</option>
                              </select>
                          </div>

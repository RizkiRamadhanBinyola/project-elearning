                    ...
                    <div class="card-body text-secondary">
                        <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="POST" enctype="multipart/form-data">
                            <div class="form-group mb-3">
                                ...
                                ?>
                                <input class="form-control <?= ($update) ? 'disabled-input' : '' ?>" value="<?php echo $kd; ?>" name="kd_guru" type="text" <?= ($update) ? 'readonly' : '' ?> />
                            </div>
                            <div class="form-group mb-3">
                                <label>NIP</label>
                                <input class="form-control <?= ($update) ? 'disabled-input' : '' ?>" placeholder="Masukkan NIP" name="nip" type="text" <?= ($update) ? 'readonly' : '' ?> <?= (!$update) ?: 'value="' . $row["nip"] . '"' ?> />
                            </div>
                            <div class="form-group mb-3">
